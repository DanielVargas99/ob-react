...
const TaskComponent = ({ task, complete, remove }) => {
    ...
    /**
     * Function that returns a Badge depending of the level of the task
     */
    ...
    return (
        <tr className={task.completed ? 'fw-normal task-completed' : ' fw-normal task-pending'}>
            ...
            <td className='align-middle'>
                {/* Execution of the function to return badge element */}
                {taskLevelBadge()}
            </td>
            <td className='align-middle'>
...
TaskComponent.propTypes = {
    // Asegurarnos que el prop que llega es una instancia de la clase Task
